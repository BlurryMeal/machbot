...
module.exports = {
	...
	execute(message, args) {
		...
		exampleEmbed.setDescription("Mach will test your skills, knowledge and determination to the bone, by putting participants to the test in a head-to-head combat. Any student from classes 7 to 11 is eligible to participate in the events - Programming, Design, Quiz, Web Development, Gaming, Group Discussion, Robotics, Audio-Visual Editing and Photography. MINET seeks to prune out the best in every category and Mach could be your doorway to join MINET.")
