...
module.exports = {
	...
	execute(message, args) {
		...
		exampleEmbed.setDescription('Design is the process of envisioning and planning an object and bringing it to life with the help of various tools and elements. Participants will be given a prompt on 31st November and would be told to make a design related to that prompt. Use your imagination and knowledge and *make* a design worthy to impress the judges.')
