...
module.exports = {
	...
	execute(message, args) {
		...
		exampleEmbed.setDescription('Web Development is the art of building and maintaining a website. One has to work with various tools and languages in order for the website to work fast and perform well with a seamless user experience. Participants have to make a website which should be related to the prompt which will be provided them on 1st November')
